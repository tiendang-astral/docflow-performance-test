/**
 * v2 / get-dossier-id-pool-by-name-filename-content — Stress Test
 * GET /v2/dossiers/{DOSSIER_ID}/pool/by-name/{FILENAME}/content
 *
 * Run:
 *   k6 run -e MAX_VU=100 tests/dossier/v2/get-dossier-id-pool-by-name-filename-content/stress.js
 */
...
export const options = {
  ...
  thresholds: {
    ...
    'http_req_duration{name:v2_get_dossier_id_pool_by_name_filename_content}': ['p(95)<5000'],
  },
};
...
export const handleSummary = buildSummary('v2-get-dossier-id-pool-by-name-filename-content-stress');
