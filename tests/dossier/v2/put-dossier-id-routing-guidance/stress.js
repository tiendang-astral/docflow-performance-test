/**
 * v2 / put-dossier-id-routing-guidance — Stress Test
 * PUT /v2/dossiers/{DOSSIER_ID}/routing-guidance
 *
 * Run:
 *   k6 run -e MAX_VU=100 tests/dossier/v2/put-dossier-id-routing-guidance/stress.js
 */
...
export const options = {
  ...
  thresholds: {
    ...
    'http_req_duration{name:v2_put_dossier_id_routing_guidance}': ['p(95)<5000'],
  },
};
...
export const handleSummary = buildSummary('v2-put-dossier-id-routing-guidance-stress');
