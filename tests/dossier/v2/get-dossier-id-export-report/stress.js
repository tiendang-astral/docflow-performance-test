/**
 * v2 / get-dossier-id-export-report — Stress Test
 * GET /v2/dossiers/{DOSSIER_ID}/export-report
 *
 * Run:
 *   k6 run -e MAX_VU=100 tests/dossier/v2/get-dossier-id-export-report/stress.js
 */
...
export const options = {
  ...
  thresholds: {
    ...
    'http_req_duration{name:v2_get_dossier_id_export_report}': ['p(95)<5000'],
  },
};
...
export const handleSummary = buildSummary('v2-get-dossier-id-export-report-stress');
