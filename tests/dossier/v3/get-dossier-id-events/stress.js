/**
 * v3 / get-dossier-id-events — Stress Test
 * GET /v3/dossiers/{DOSSIER_ID}/events
 *
 * Run:
 *   k6 run -e MAX_VU=100 tests/dossier/v3/get-dossier-id-events/stress.js
 */
...
export const options = {
  ...
  thresholds: {
    ...
    'http_req_duration{name:v3_get_dossier_id_events}': ['p(95)<5000'],
  },
};
...
export const handleSummary = buildSummary('v3-get-dossier-id-events-stress');
