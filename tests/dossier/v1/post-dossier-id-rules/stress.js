/**
 * v1 / post-dossier-id-rules — Stress Test
 * POST /v1/dossiers/{DOSSIER_ID}/rules
 *
 * Run:
 *   k6 run -e MAX_VU=100 tests/dossier/v1/post-dossier-id-rules/stress.js
 */
...
export const options = {
  ...
  thresholds: {
    ...
    'http_req_duration{name:v1_post_dossier_id_rules}': ['p(95)<5000'],
  },
};
...
export const handleSummary = buildSummary('v1-post-dossier-id-rules-stress');
