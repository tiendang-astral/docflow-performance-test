...
#
# Usage:
#   bash tests/luong-04/run-all.sh
#   BASE_URL=http://staging:29002/api bash tests/luong-04/run-all.sh
#   bash tests/luong-04/run-all.sh smoke load   # chỉ chạy 1 số test
