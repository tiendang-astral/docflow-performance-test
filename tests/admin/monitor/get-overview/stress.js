/**
 * monitor / get-overview — Stress Test
 * GET /v1/admin/monitor/overview
 *
 * Run:
 *   k6 run -e MAX_VU=100 tests/admin/monitor/get-overview/stress.js
 */
...
export const options = {
  ...
  thresholds: {
    ...
    'http_req_duration{name:monitor_get_overview}': ['p(95)<5000'],
  },
};
...
export const handleSummary = buildSummary('monitor-get-overview-stress');
