/**
 * form-templates / put-template-id — Stress Test
 * PUT /v1/form-templates/{TEMPLATE_ID}
 *
 * Run:
 *   k6 run -e MAX_VU=100 tests/form-rule/form-templates/put-template-id/stress.js
 */
...
export const options = {
  ...
  thresholds: {
    ...
    'http_req_duration{name:form_templates_put_template_id}': ['p(95)<5000'],
  },
};
...
export const handleSummary = buildSummary('form-templates-put-template-id-stress');
