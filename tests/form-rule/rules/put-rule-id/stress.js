/**
 * rules / put-rule-id — Stress Test
 * PUT /v1/rules/{RULE_ID}
 *
 * Run:
 *   k6 run -e MAX_VU=100 tests/form-rule/rules/put-rule-id/stress.js
 */
...
export const options = {
  ...
  thresholds: {
    ...
    'http_req_duration{name:rules_put_rule_id}': ['p(95)<5000'],
  },
};
...
export const handleSummary = buildSummary('rules-put-rule-id-stress');
