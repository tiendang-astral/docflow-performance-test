/**
 * Endpoints — Rules — Load Test
 * Mục tiêu: kiểm tra hành vi ở mức tải thông thường.
 *
 * Run:
 *   k6 run tests/endpoints/rules/load.js
 *   k6 run -e BASE_URL=http://staging:29002/api tests/endpoints/rules/load.js
 */
...
export const handleSummary = buildSummary('rules-load');
