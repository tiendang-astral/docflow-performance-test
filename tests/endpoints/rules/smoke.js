/**
 * Endpoints — Rules — Smoke Test
 * Mục tiêu: xác nhận script và môi trường hoạt động đúng với tải tối thiểu.
 *
 * Run:
 *   k6 run tests/endpoints/rules/smoke.js
 *   k6 run -e BASE_URL=http://staging:29002/api tests/endpoints/rules/smoke.js
 */
...
export const options = {
  ...
  thresholds: {
    ...
    'http_req_duration{name:list_rule_tags}':  ['p(95)<1000'],
    'http_req_duration{name:patch_rule_tags}': ['p(95)<1200'],
...
export const handleSummary = buildSummary('rules-smoke');
