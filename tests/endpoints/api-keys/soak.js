/**
 * Endpoint: api-keys — Soak Test
 * Mục tiêu: phát hiện memory leak, connection leak khi tải kéo dài.
 *
 * Run:
 *   k6 run tests/endpoints/api-keys/soak.js
 *   k6 run -e BASE_URL=http://staging:29002/api tests/endpoints/api-keys/soak.js
 */
...
export const handleSummary = buildSummary('api-keys-soak');
