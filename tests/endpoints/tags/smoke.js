/**
 * Endpoint: tags — Smoke Test
 * Mục tiêu: xác nhận script và môi trường hoạt động đúng với tải tối thiểu.
 *
 * Run:
 *   k6 run tests/endpoints/tags/smoke.js
 *   k6 run -e BASE_URL=http://staging:29002/api tests/endpoints/tags/smoke.js
 */
...
export const handleSummary = buildSummary('tags-smoke');
