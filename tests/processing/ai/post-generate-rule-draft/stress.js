/**
 * ai / post-generate-rule-draft — Stress Test
 * POST /v1/ai/generate-rule-draft
 *
 * Run:
 *   k6 run -e MAX_VU=100 tests/processing/ai/post-generate-rule-draft/stress.js
 */
...
export const options = {
  ...
  thresholds: {
    ...
    'http_req_duration{name:ai_post_generate_rule_draft}': ['p(95)<5000'],
  },
};
...
export const handleSummary = buildSummary('ai-post-generate-rule-draft-stress');
