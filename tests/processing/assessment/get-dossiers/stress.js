/**
 * assessment / get-dossiers — Stress Test
 * GET /v1/assessment/dossiers
 *
 * Run:
 *   k6 run -e MAX_VU=100 tests/processing/assessment/get-dossiers/stress.js
 */
...
export const options = {
  ...
  thresholds: {
    ...
    'http_req_duration{name:assessment_get_dossiers}': ['p(95)<5000'],
  },
};
...
export const handleSummary = buildSummary('assessment-get-dossiers-stress');
