/**
 * assessment / put-dossier-id-forms-form-id-fields-field-id-verify — Stress Test
 * PUT /v1/assessment/{DOSSIER_ID}/forms/{FORM_ID}/fields/{FIELD_ID}/verify
 *
 * Run:
 *   k6 run -e MAX_VU=100 tests/processing/assessment/put-dossier-id-forms-form-id-fields-field-id-verify/stress.js
 */
...
export const options = {
  ...
  thresholds: {
    ...
    'http_req_duration{name:assessment_put_dossier_id_forms_form_id_fields_field_id_verify}': ['p(95)<5000'],
  },
};
...
export const handleSummary = buildSummary('assessment-put-dossier-id-forms-form-id-fields-field-id-verify-stress');
