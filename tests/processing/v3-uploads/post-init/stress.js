/**
 * v3-uploads / post-init — Stress Test
 * POST /v3/uploads/init
 *
 * Run:
 *   k6 run -e MAX_VU=100 tests/processing/v3-uploads/post-init/stress.js
 */
...
export const options = {
  ...
  thresholds: {
    ...
    'http_req_duration{name:v3_uploads_post_init}': ['p(95)<5000'],
  },
};
...
export const handleSummary = buildSummary('v3-uploads-post-init-stress');
