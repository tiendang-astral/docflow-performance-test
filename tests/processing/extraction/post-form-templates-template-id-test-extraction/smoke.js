/**
 * extraction / post-form-templates-template-id-test-extraction — Smoke Test
...
export const options = {
  ...
  thresholds: {
    ...
    'http_req_duration{name:extraction_post_form_templates_template_id_test_extraction}': ['p(95)<3000'],
  },
};
