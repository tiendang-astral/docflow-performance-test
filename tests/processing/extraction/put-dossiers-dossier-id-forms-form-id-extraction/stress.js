/**
 * extraction / put-dossiers-dossier-id-forms-form-id-extraction — Stress Test
 * PUT /v1/extraction/dossiers/{DOSSIER_ID}/forms/{FORM_ID}/extraction
 *
 * Run:
 *   k6 run -e MAX_VU=100 tests/processing/extraction/put-dossiers-dossier-id-forms-form-id-extraction/stress.js
 */
...
export const options = {
  ...
  thresholds: {
    ...
    'http_req_duration{name:extraction_put_dossiers_dossier_id_forms_form_id_extraction}': ['p(95)<5000'],
  },
};
...
export const handleSummary = buildSummary('extraction-put-dossiers-dossier-id-forms-form-id-extraction-stress');
