/**
 * upload / post-form-templates-template-id-upload-template-file — Stress Test
 * POST /v1/upload/form-templates/{TEMPLATE_ID}/upload-template-file
 *
 * Run:
 *   k6 run -e MAX_VU=100 tests/processing/upload/post-form-templates-template-id-upload-template-file/stress.js
 */
...
export const options = {
  ...
  thresholds: {
    ...
    'http_req_duration{name:upload_post_form_templates_template_id_upload_template_file}': ['p(95)<5000'],
  },
};
...
export const handleSummary = buildSummary('upload-post-form-templates-template-id-upload-template-file-stress');
