/**
 * Luồng 06 — Load Test
 * Mục tiêu: kiểm tra luồng thiết kế hồ sơ trên canvas ở mức tải thông thường.
 *
 * Run:
 *   k6 run tests/luong-06/load.js
 *   k6 run -e BASE_URL=http://staging:29002/api tests/luong-06/load.js
 */
...
export const handleSummary = buildSummary('luong-06-load');
